...
document.getElementById('surveyForm').addEventListener('submit', function(event) {
    ...
    fetch('https://script.google.com/macros/s/AKfycbzon5NlyeWKh0qphJv--RubJ9wS78Js-ZmeEDkKBf_oCC9YEI9RUS0oPYO_v966H_7S/exec', {
        method: 'POST',
        headers: {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    function updateLegend(scaleType) {
        ...
        if (scaleType === "tremor") {
            ...
            legendTitle.innerText = "Writing Scale";
            scaleList.innerHTML = `
                <div class="scale-item">0 = Normal</div>
                <div class="scale-item">1 = Mildly abnormal. Slightly untidy, tremulous.</div>
                <div class="scale-item">2 = Moderately abnormal. Legible, but with considerable tremor.</div>
                <div class="scale-item">3 = Markedly abnormal. Illegible.</div>
                <div class="scale-item">4 = Severely abnormal.</div>
            `;
        }
    }
});
